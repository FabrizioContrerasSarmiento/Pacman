...
let heart_img;
  ...
  function preload() {
    ...
    heart_img = loadImage('images/con_vida.png');
  ...
  function setup(players_num) {
    ...
    const W = CFG.canvas.width || 810;
    const H = CFG.canvas.height || 810;
    createCanvas(W, H);
    background(0);
  ...
  function draw() {
    ...
    const fit = Math.min(windowWidth / width, windowHeight / height, 0.75) * 1;
    window.currentFit = fit; 
